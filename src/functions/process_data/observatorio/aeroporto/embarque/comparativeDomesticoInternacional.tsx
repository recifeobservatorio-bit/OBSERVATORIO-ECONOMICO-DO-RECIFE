...
//           (item[campo] || "0").replace(/\./g, "").replace(",", ".")
//         );
...
//     const dadosDomestico = data.filter(item => item["NATUREZA"] === "Doméstica");
//     const dadosInternacional = data.filter(item => item["NATUREZA"] === "Internacional");
