...
const GraficoPassageirosPorMesAno: React.FC<GraficoPassageirosPorMesAnoProps> = ({ data, municipio, year, color }) => {
  ...
  return (
    <div className="w-full bg-white p-6 rounded-lg shadow-lg">
        ...
        >
        Passageiros em {municipio} ({year}) {showRecife && "e Recife para Comparação"}
        </h3>
      ...
      <ResponsiveContainer width="100%" height={300}>
        <LineChart data={chartData} margin={{ top: 20, right: 20, left: 5, bottom: 5 }}>
          ...
          <YAxis
            tick={{ fontSize: tickFontSize }}
            label={{ value: "Passageiros", angle: -90, position: "insideLeft", offset: 1, fontSize: 12 }}
          />
