        ...
        <footer className="flex text-white">
            ...
            <div className="flex description-content">
                ...
                <div className="flex flex-col __rows">
                    ...
                    <p className="__description">www.desenvolvimentoeconomico.recife.pe.gov.br</p>
                    </div>
                </div>
                </div>
                ...
                <div className="flex flex-col __rows">
                    ...
                    <p className="__description">Rua do Brum, 123 - 3o andar - Empresarial Maurício<br/>Brandão Mattos - Bairro do Recife, Recife-PE</p>
                    </div>
                    <div className="flex items-center __row item2">
                    <div className="__icon">
