...
export const Banner: React.FC<BannerProps> = ({ onSearch }) => {
  ...
  return (
    <section className="bg-[url('/images/backgrounds/home_carousel/carousel_1.png')] w-full bg-bottom">
